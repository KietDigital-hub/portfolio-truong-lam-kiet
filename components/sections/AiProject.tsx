        ...
        <div className="mt-12 grid gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
              ...
              <div className="relative aspect-video overflow-hidden rounded-3xl border-[6px] border-dark bg-dark shadow-2xl">
                {playing ? (
                  ...
                  >
                    ...
                    <span className="absolute left-1/2 top-1/2 flex h-20 w-20 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-lime text-on-accent shadow-xl transition-transform duration-300 group-hover:scale-110">
                      <Play size={30} strokeWidth={2.6} className="ml-1 fill-on-accent" />
                    </span>
                  </button>
                )}
              </div>

              <div className="absolute -bottom-4 -left-2 -rotate-2 rounded-2xl border border-lime/25 bg-dark-2 px-5 py-3 text-cream shadow-lg sm:-left-4">
          ...
          <Reveal delay={0.18}>
            <div className="rounded-3xl border border-ink/10 bg-oat-card/50 p-8 sm:p-10">
              ...
              <NoteText className="mt-6" label="Về dự án">
              ...
              <a
                ...
                className="mt-8 inline-flex items-center gap-2 rounded-full bg-lime px-5 py-3 text-sm font-bold text-on-accent transition-transform hover:-translate-y-0.5"
              >
                Xem trên YouTube
