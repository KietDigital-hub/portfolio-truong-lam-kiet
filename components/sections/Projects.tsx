...
const CARD_IMAGES: Record<string, string> = {
  "01": "/images/deco-analytics.jpg",
  "02": "/images/deco-design.jpg",
};
...
const slides: Slide[] = [
  { kind: "intro" },
  ...projects.map((p, i) => ({ kind: "project" as const, index: String(i + 1).padStart(2, "0"), data: p })),
];
              ...
              return (
                ...
                >
                  <div className="relative h-40 w-full">
                    ...
                    <span className="absolute left-6 top-5 rounded-full bg-dark/70 px-3 py-1 text-xs font-black text-cream/70 backdrop-blur">
                      {slide.index}
                    </span>
                    <span className="absolute right-6 top-5 rounded-full bg-lime px-3 py-1 text-xs font-bold text-on-accent">
                      {project.role}
                    </span>
                  </div>
                  ...
                  <Link
                    ...
                    className="absolute bottom-6 right-6 inline-flex h-11 w-11 items-center justify-center rounded-full bg-lime text-on-accent transition-transform duration-300 group-hover:rotate-45"
                  >
